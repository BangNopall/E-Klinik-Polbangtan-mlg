...
return new class extends Migration
{
    ...
    {
        Schema::create('surat_keterangan_berobats', function (Blueprint $table) {
            $table->id();
            ...
            // DMTI
            $table->string('nik', 16);
            $table->string('no_bpjs', 16)->nullable()->default(null);
    ...
    {
        Schema::dropIfExists('surat_keterangan_berobats');
    }
};
