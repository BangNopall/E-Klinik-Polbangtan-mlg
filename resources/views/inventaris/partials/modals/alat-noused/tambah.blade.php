<x-modal name="tambah-item">
    <div class="relative p-4 sm:p-5 w-full max-w-2xl h-full md:h-auto">
        ...
        <div class="relative">
            ...
            <!-- Modal body -->
            <form action="{{ route('inventaris.consumable.store') }}" method="post" id="additemform">
                @csrf
    ...
    <div id="url_kategori_consumable" class="hidden"></div>
    <script>
        const url = '{{ route('api.getKategoriConsumables') }}';
        const element = document.getElementById('url_kategori_consumable');
