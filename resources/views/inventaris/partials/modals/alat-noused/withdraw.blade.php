<x-modal name="withdraw-alat">
    <div class="relative p-4 sm:p-5 w-full max-w-2xl h-full md:h-auto">
        ...
        <div class="relative">
            ...
            <!-- Modal body -->
            <form action="{{ route('inventaris.consumable.withdraw', $data->id) }}" method="post" id="additemform">
                @csrf
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    <div>
                        ...
                        <input type="text" id="user_id_wd" class="hidden" name="user_id">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <x-input-text type="date" name="date" id="tanggal" class="p-2.5"
                            placeholder="20-02-2024" required="" value="{{ date('Y-m-d') }}" />
                    </div>
                    <div>
                        <x-input-label for="waktu" class="mb-2">Waktu</x-input-label>
                        <x-input-text type="time" name="time" id="waktu" class="p-2.5" placeholder="06:00"
