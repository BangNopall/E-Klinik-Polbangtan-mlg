                    ...
                    <section>
                        ...
                        <div class="mt-3 bg-green-100 dark:bg-green-800 p-3 rounded">
                            <p class="text-green-800 dark:text-green-100 text-sm">Tidak dapat melakukan perubahan pada
                                dokumen. Anda dapat membuat ulang dokumen serupa dengan pindah kode QR pasien</p>
                        </div>
                        <form action="{{ route('kesehatan.form.surat-keterangan-rujukan.print', $surat->id) }}"
