                    ...
                    <section>
                        ...
                        <div class="mt-3 bg-gray-100 dark:bg-dark p-3 rounded">
                            ...
                            <div class="mt-3 text-sm">
                                <p>
                                    Telah berobat di Klinik Polbangtan Malang pada hari jumat tanggal 20 Januari 2012
                                    dengan diagnosa <span class="uppercase">{{ $surat->diagnosa }}</span>
                                </p>
                                <br>
                                <p>
                        ...
                        <form action="{{ route('kesehatan.form.surat-keterangan-berobat.print', $surat->id) }}" class="flex gap-2 mt-3" method="get">
                            @csrf
