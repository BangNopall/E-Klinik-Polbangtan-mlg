            ...
            <div class="p-4 bg-white dark:bg-darker sm:rounded-lg w-full">
                <div class="w-full">
                    <section>
                        ...
                        <form action="{{ route('kesehatan.request-rujukan-konseling.store', ['id' => $user->id, 'requestId' => $requestId]) }}" method="POST">
                            @csrf
                            @method('PATCH')
                            <div class="mt-3 bg-gray-100 dark:bg-dark p-3 rounded">
                                                        ...
                                                        <div @click="onOptionClick(index)"
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="w-full items-center flex">
                                                                    <span x-text="option.nama_rs"
                                                                        id="nama_rs_span"></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </template>
                                    ...
                                    <div class="grid gap-2 md:grid-cols-2 mt-2">
                                        <div>
                                            ...
                                            <textarea name="keluhan" id="cek_fisik" cols="5" rows="5" required
                                                class="block w-full mt-2 items-center text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-darker dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">{{ $dataPsikolog->keluhan }}</textarea>
                                        ...
                                        <div>
                                            ...
                                            <textarea name="tindakan" id="tindakan" cols="5" rows="5" required
                                                class="block w-full mt-2 items-center text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-darker dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">{{ $dataPsikolog->metode_psikologi }}</textarea>
