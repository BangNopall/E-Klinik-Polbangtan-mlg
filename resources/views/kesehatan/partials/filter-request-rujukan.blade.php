<form action="{{ route('kesehatan.filter-request-rujukan-konseling') }}" method="post" id="form-filter">
    @csrf
    <div class="flex flex-col sm:flex-row justify-between">
        <div class="flex flex-wrap gap-1">
            <div class="w-auto md:w-[300px]">
                <div class="space-y-1">
                    <x-input-label for="filter" class="mb-2">Cari</x-input-label>
                    <div class="relative">
                        ...
                        <x-input-text type="search" id="filter" name="filter" class="w-full p-2 ps-8"
                            placeholder="Nim, pengguna, keluhan" />
                    </div>
                </div>
            </div>
        </div>
