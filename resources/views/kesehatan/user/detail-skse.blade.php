<x-app-layout>
    ...
    <div class="px-2 sm:px-4 py-3 lg:py-5 border-b dark:border-blue-800">
        <h1 class="text-xl sm:text-2xl font-semibold">Surat Keterangan Sehat</h1>
            ...
            <div class="p-4 bg-white dark:bg-darker sm:rounded-lg w-full">
                <div class="w-full">
                    <section>
                        ...
                        <form action="{{ route('user.kesehatan.surat-keterangan-sehat.print', $surat->id) }}" class="flex gap-2 mt-3" method="get">
                            @csrf
                            <x-button class="py-2 px-4 mt-2"
                                type="submit">{{ __('Unduh Dokumen') }}</x-button>
                        </form>
                    </section>
                </div>
            </div>
