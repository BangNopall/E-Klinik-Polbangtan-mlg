<x-app-layout>
    ...
    <div class="flex items-center justify-between px-2 sm:px-4 py-3 lg:py-5 border-b dark:border-blue-800">
        <h1 class="text-2xl font-semibold">Kode QR Klinik</h1>
    </div>
    {{-- Main Content --}}
    @include('kesehatan.partials.modals.qr')
    <div class="px-2 sm:px-4 py-3 lg:py-5">
        <div class="bg-white dark:bg-darker rounded-lg shadow-lg w-full md:max-w-xl mx-auto p-3 md:p-5">
            <div class="relative max-w-sm transition-all duration-300 filter mx-auto w-[60%] mt-5">
                <img class="rounded-lg w-full bg-gray-500 dark:bg-dark" src="{{ asset('img/qr-test-aja.svg') }}" alt="Kode QR">
            ...
            <div class="text-center mt-5">
                ...
                <div class="text-sm text-gray-700 dark:text-gray-200">
                    Pindai kode QR untuk menjalani prosedur Klinik Polbangtan-mlg
                </div>
            </div>
            <div class="bg-gray-100 dark:bg-dark w-full rounded-lg mt-5 p-3">
                ...
                <ul class="text-gray-900 dark:text-gray-200 text-sm">
                    ...
                    <li>
                        <span class="font-medium text-black dark:text-white">No. HP : </span> {{ $user->getDMTI->no_hp }}
                    </li>
                    <li>
                        <span class="font-medium text-black dark:text-white">Usia : </span> {{ $user->getDMTI->usia }}
                    </li>
                    {{-- <li>
                        <span class="font-medium text-black dark:text-white">Token : </span> {{ $user->kesehatan_token }}
                    </li>
                    <li>
                        <span class="font-medium text-black dark:text-white">Token Expired: </span> {{ $user->kesehatan_token_expired_at }}
                    </li> --}}
                </ul>
            </div>
        </div>
