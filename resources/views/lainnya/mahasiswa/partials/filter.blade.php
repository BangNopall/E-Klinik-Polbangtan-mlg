<form action="{{ route('lainnya.mahasiswa.filter') }}" method="post" id="form-filter">
    @csrf
    <div class="flex flex-col sm:flex-row justify-between">
        <div class="flex flex-wrap gap-1">
            <div class="w-auto md:w-[300px]">
                <div class="space-y-1">
                    <x-input-label for="filter" class="mb-2">Cari Data Mahasiswa</x-input-label>
                    <div class="relative">
            ...
            <div>
                <x-input-label class="mb-2" for="prodi">Prodi</x-input-label>
                <select name="prodi" id="prodi"
                    ...
                    <option value="AGRINAK">AGRINAK</option>
                </select>
            </div>
        </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#filter, #prodi').on('input', function() {
