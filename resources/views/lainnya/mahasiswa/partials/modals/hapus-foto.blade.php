<x-modal name="hapus-foto">
    <div class="flex justify-center items-center relative p-4 w-full h-full md:h-auto z-50">
        <!-- Modal content -->
        <div class="relative p-4 text-center sm:p-5 w-full">
            ...
            <p class="mb-4 text-gray-500 dark:text-gray-300">Apakah Anda yakin menghapus foto?</p>
