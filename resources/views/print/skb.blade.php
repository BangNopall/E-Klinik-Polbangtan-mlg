    ...
    <table style="margin-top: 5px;">
        <tr>
            <td>
                ...
                <p>Telah berobat di Klinik Polbangtan Malang pada hari {{ \Carbon\Carbon::parse($surat->created_at)->translatedFormat('l') }} tanggal {{ \Carbon\Carbon::parse($surat->created_at)->translatedFormat('d F Y') }} dengan diagnosa <span style="text-transform: uppercase;">{{ $surat->diagnosa }}</span></p>
                <p>Demikian surat keterangan ini kami buat dan dapat dipertanggung jawabkan sebagaimana mestinya.</p>
            </td>
        </tr>
    </table>
