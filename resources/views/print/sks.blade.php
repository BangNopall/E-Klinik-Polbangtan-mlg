...
<html lang="en">
  ...
  <body>
    ...
    <table style="margin-top: 5px;">
        <tr>
            <td>
                <p>Karena sakit diberi istirahat selama {{ $surat->lama_sakit }} hari, mulai tanggal {{ \Carbon\Carbon::parse($surat->tanggal_mulai)->translatedFormat('d F Y') }} s/d {{ \Carbon\Carbon::parse($surat->tanggal_akhir)->translatedFormat('d F Y') }}.</p>
            </td>
        </tr>
    </table>
